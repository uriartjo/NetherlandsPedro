...
@TeleOp(name="NetherlandsAuto")
public class NetherlandsAuto extends OpMode {
    ...
    public void init() {
        ...
        // Initialize PedroPathing Follower with proper constructor
        Constants.setConstants(FConstants.class, LConstants.class);
        follower = new Follower(hardwareMap, FConstants.class, LConstants.class);

        // Set starting pose (adjust coordinates as needed)
    ...
    public void loop() {
        ...
        // Viper slide controls (unchanged)
        if (righty2 <= -0.7) {
        ...
        // PedroPathing drive control - replaces RoadRunner
        follower.setTeleOpMovementVectors(
                -gamepad1.left_stick_y,    // Forward/backward (Y-axis)
                -gamepad1.left_stick_x,    // Strafe left/right (X-axis)
                -gamepad1.right_stick_x,   // Rotation
                true                       // Field-centric mode (set to false for robot-centric)
        );
